...
struct dis_entry disass_pdk_14[]= {
  ...
  { 0x1C00, ~0x003F, ' ', 2, "set0 %i, %k" },
  { 0x2400, ~0x003F, ' ', 2, "set0 %m, %k" },
  { 0x1E00, ~0x003F, ' ', 2, "set1 %i, %k" },
  { 0x2600, ~0x003F, ' ', 2, "set1 %m, %k" },
  { 0x1800, ~0x003F, ' ', 2, "t0sn %i, %k" },
  { 0x2000, ~0x003F, ' ', 2, "t0sn %m, %k" },
  { 0x1A00, ~0x003F, ' ', 2, "t1sn %i, %k" },
  { 0x2200, ~0x003F, ' ', 2, "t1sn %m, %k" },
