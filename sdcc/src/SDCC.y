...
%token DUMMY_READ_VOLATILE ENDCRITICAL SWAP INLINE NORETURN RESTRICT SMALLC RAISONANCE IAR COSMIC SDCCOLDCALL PRESERVES_REGS Z88DK_FASTCALL Z88DK_CALLEE ALIGNAS Z88DK_SHORTCALL Z88DK_PARAMS_OFFSET
...
function_attributes
   ...
   |  SDCCOLDCALL    {  $$ = newLink (SPECIFIER);
                        FUNC_ISSDCCOLDCALL($$) = 1;
                     }
