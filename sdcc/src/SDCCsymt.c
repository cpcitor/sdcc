...
mergeSpec (sym_link * dest, sym_link * src, const char *name)
{
  ...
  if (FUNC_ISRAISONANCE (dest) && (FUNC_ISIAR (src) || FUNC_ISCOSMIC (src) || FUNC_ISSDCCOLDCALL (src) || FUNC_ISZ88DK_CALLEE (src)) ||
    FUNC_ISIAR (dest) && (FUNC_ISRAISONANCE (src) || FUNC_ISCOSMIC (src) || FUNC_ISSDCCOLDCALL (src) || FUNC_ISZ88DK_CALLEE (src)) ||
    FUNC_ISCOSMIC (dest) && (FUNC_ISRAISONANCE (src) || FUNC_ISIAR (src) || FUNC_ISSDCCOLDCALL (src) || FUNC_ISZ88DK_CALLEE (src)) ||
    FUNC_ISSDCCOLDCALL (dest) && (FUNC_ISRAISONANCE (src) || FUNC_ISIAR (src) || FUNC_ISCOSMIC (src)) || // __sdcc_oldcall can be combined with __z88dk_callee.
