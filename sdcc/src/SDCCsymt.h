...
typedef struct sym_link
{
  ...
  struct
  {
    ...
    unsigned sdccoldcall:1;         /* Use old sdcc calling convention */
...
#define FUNC_ISSDCCOLDCALL(x) (x->funcAttrs.sdccoldcall)
#define IFFUNC_ISSDCCOLDCALL(x) (IS_FUNC(x) && FUNC_ISSDCCOLDCALL(x))
